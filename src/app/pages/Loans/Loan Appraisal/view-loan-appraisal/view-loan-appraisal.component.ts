...
@Component({
  selector: 'app-view-loan-appraisal',
  templateUrl: './view-loan-appraisal.component.html',
  styleUrls: ['./view-loan-appraisal.component.scss']
})
export class ViewLoanAppraisalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.refreshList();
    this.service.GetTotalLoanAppraised().subscribe(Response =>{
  ...
  refreshList(){
    ...
    this.service.getAllLoanAppraisedAPPlication().subscribe(Response =>{
